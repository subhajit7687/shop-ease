import 'package:e_commerce/features/products/product_reviews/ui/widgets/rating_progress_indicator.dart';
...
class OverallProductRating extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        Expanded(flex: 3, child: Text('4.8', style: textTheme.displayLarge)),
        Expanded(
          flex: 7,
          child: Column(
            children: [
